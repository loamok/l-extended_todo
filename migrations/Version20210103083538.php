 ...
 */
final class Version20210103083538 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE fb_type (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', code VARCHAR(255) NOT NULL, label VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE freebusy (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', agenda_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', type_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', created_by VARCHAR(255) DEFAULT NULL, updated_by VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, timezone VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, end_at DATETIME NOT NULL, duration VARCHAR(255) NOT NULL COMMENT \'(DC2Type:dateinterval)\', start_at DATETIME NOT NULL, INDEX IDX_EF64A71DEA67784A (agenda_id), INDEX IDX_EF64A71DC54C8C93 (type_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE wt_parameters (id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', user_id BINARY(16) NOT NULL COMMENT \'(DC2Type:uuid)\', agenda_id BINARY(16) DEFAULT NULL COMMENT \'(DC2Type:uuid)\', name VARCHAR(255) NOT NULL, default_config TINYINT(1) NOT NULL, active TINYINT(1) NOT NULL, global TINYINT(1) NOT NULL, created_by VARCHAR(255) DEFAULT NULL, updated_by VARCHAR(255) DEFAULT NULL, deleted_at DATETIME DEFAULT NULL, timezone VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_E1E08FBFA76ED395 (user_id), INDEX IDX_E1E08FBFEA67784A (agenda_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE freebusy ADD CONSTRAINT FK_EF64A71DEA67784A FOREIGN KEY (agenda_id) REFERENCES agenda (id)');
        $this->addSql('ALTER TABLE freebusy ADD CONSTRAINT FK_EF64A71DC54C8C93 FOREIGN KEY (type_id) REFERENCES fb_type (id)');
        ...
        $this->addSql('ALTER TABLE wt_parameters ADD CONSTRAINT FK_E1E08FBFA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE wt_parameters ADD CONSTRAINT FK_E1E08FBFEA67784A FOREIGN KEY (agenda_id) REFERENCES agenda (id)');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE freebusy DROP FOREIGN KEY FK_EF64A71DEA67784A');
        $this->addSql('ALTER TABLE journal DROP FOREIGN KEY FK_C1A7E74DEA67784A');
        $this->addSql('ALTER TABLE related DROP FOREIGN KEY FK_60577090EA67784A');
        $this->addSql('ALTER TABLE todo DROP FOREIGN KEY FK_5A0EB6A0EA67784A');
        $this->addSql('ALTER TABLE wt_parameters DROP FOREIGN KEY FK_E1E08FBFEA67784A');
        ...
        $this->addSql('ALTER TABLE related DROP FOREIGN KEY FK_6057709071F7E88B');
        $this->addSql('ALTER TABLE freebusy DROP FOREIGN KEY FK_EF64A71DC54C8C93');
        $this->addSql('ALTER TABLE related DROP FOREIGN KEY FK_60577090D9267A93');
        $this->addSql('ALTER TABLE journal_category DROP FOREIGN KEY FK_D6FCB478478E8802');
        $this->addSql('ALTER TABLE related DROP FOREIGN KEY FK_60577090478E8802');
        ...
        $this->addSql('ALTER TABLE related DROP FOREIGN KEY FK_60577090EA1EBC33');
        ...
        $this->addSql('ALTER TABLE wt_parameters DROP FOREIGN KEY FK_E1E08FBFA76ED395');
        ...
        $this->addSql('DROP TABLE fb_type');
        $this->addSql('DROP TABLE freebusy');
        ...
        $this->addSql('DROP TABLE wt_parameters');
    }
}
